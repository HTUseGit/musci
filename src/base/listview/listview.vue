<template>
  <scroll class="listview" :probeType="probeType" :data="data" ref="listview" :listenScroll="listenScroll" @scroll="scroll">
    ...
    <div class="list-shortcut">
      <ul>
        <li v-for="(item, index) in shortcutList" :key="index" :class="{'current': currentIndex === index}" class="item" @touchstart="onShortCutStart($event, index)" @touchmove.stop.prevent="onShortCutTouchMove">{{item}}</li>
      </ul>
    </div>
