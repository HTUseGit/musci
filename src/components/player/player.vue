    ...
    <transition name="normal" @enter="enter" @after-enter="afterEnter" @leave="leave" @after-leave="afterLeave">
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="middle" @touchstart.prevent="middleTouchStart" @touchmove.prevent="middleTouchMove" @touchend="middleTouchEnd">
          ...
          <scroll class="middle-r" ref="lyricList" :data="currentLyric.lines && currentLyric">
            <div class="lyric-wrapper">
              <div v-if="currentLyric">
                <p ref="lyricLine" v-for="(line, index) in currentLyric.lines" :key="index" :class="{current: currentLineNum === index}" class="text">
                  {{line.txt}}
                </p>
              </div>
            </div>
        ...
        <div class="bottom">
          <div class="dot-wrapper">
            <span class="dot" :class="currentShow==='cd'"></span>
            <span class="dot" :class="currentShow==='lyric'"></span>
          </div>
